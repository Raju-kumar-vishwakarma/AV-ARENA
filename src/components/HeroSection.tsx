...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <div className="container relative z-10 px-4 py-24 mx-auto">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-primary/60 via-accent/40 to-secondary/60 border border-primary/40 shadow-neon animate-fade-in animate-bounce">
            ...
            <span className="text-sm font-bold text-foreground tracking-wider drop-shadow-neon">
          ...
          {/* Description */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 animate-fade-in">
            <Link to="/auth">
              <Button
                variant="hero"
                size="lg"
                className="text-lg shadow-neon group animate-bounce-slow"
              >
            ...
            <a href="#tournaments">
              <Button
                variant="outline"
                size="lg"
                className="text-lg border-primary/50 hover:border-primary animate-pulse"
              >
          ...
          <div className="pt-16 px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-5xl mx-auto text-center">
              ...
              <div className="space-y-2 group hover:scale-110 transition-transform animate-fade-in">
                <div className="text-4xl sm:text-5xl font-black bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent drop-shadow-neon animate-pulse">
                  50K+
                </div>
                <div className="text-sm sm:text-base text-foreground/80 font-semibold">
                  Active Players
                </div>
              </div>
              ...
              {/* Tournaments */}
              <div className="space-y-2 group hover:scale-110 transition-transform animate-fade-in">
                <div className="text-4xl sm:text-5xl font-black bg-gradient-to-r from-accent to-secondary bg-clip-text text-transparent drop-shadow-neon animate-pulse">
                  1000+
                </div>
                <div className="text-sm sm:text-base text-foreground/80 font-semibold">
                  Tournaments
              ...
              {/* Prize Pool */}
              <div className="space-y-2 group hover:scale-110 transition-transform animate-fade-in">
                <div className="text-4xl sm:text-5xl font-black bg-gradient-to-r from-secondary to-primary bg-clip-text text-transparent drop-shadow-neon animate-pulse">
                  $2M+
                </div>
                <div className="text-sm sm:text-base text-foreground/80 font-semibold">
                  Prize Pool
      ...
      />
      <div
        className="absolute top-1/2 left-1/2 w-96 h-96 bg-accent/20 rounded-full blur-3xl animate-pulse"
